...
namespace apetito.meinapetito.Webhooks.Prismic.Infrastructure
{
    public static class AppConfigurationExtensions
    {
            ...
            IConfiguration? configuration)
        {
            try
            {
                ...
                var keyPrefix = "apetito:meinapetito:webhooks:prismic:api:";
            
            
            Console.WriteLine($"AZURE_CLIENT_ID : {servicePrincipalClientId}");
            Console.WriteLine($"AZURE_CLIENT_SECRET : {servicePrincipalclientSecret}");
