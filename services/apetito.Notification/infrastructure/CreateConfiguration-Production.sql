...
AS
(
              SELECT 'E601478F-7E96-423D-9E76-F97AA98E1CE3', '6B8A9EE5-8593-48C8-9952-85BACDF029DB', 'SENDGRID', 'https://mein.apetito.de/api/root/infrastructure/email/{ReferenceId}', 'NONE', '{}', GETDATE()
              union all
              SELECT '452739AB-AF1B-4786-9291-332BCB9A7106','B8D3D907-1AD5-400E-97CF-F153D6CD4E72', 'SENDGRID', 'https://mein.apetito.de/api/root/infrastructure/email/{ReferenceId}','NONE','{}', GETDATE()
)
