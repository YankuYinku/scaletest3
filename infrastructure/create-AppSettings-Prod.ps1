...
CreateSetting "apetito:meinapetito:portal:api:AzureADB2C:PostRegistrationWebhook:BaseUrl" "https://mein.apetito.de"
...
CreateSetting "apetito:meinapetito:portal:api:ProductCatalog:MeinApetitoApi:Address" "https://mein.apetito.de/api/"
...
CreateSetting "apetito:meinapetito:portal:api:Prismic:Endpoint" "https://meinapetito.prismic.io/api/v1"
